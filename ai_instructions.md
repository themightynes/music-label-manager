...
- **Current Phase**: between phases — Phase 4 (game feel) has no tickets yet; "Phase 3.5" (gameState→TanStack, the deferred spine migration) is the other candidate
