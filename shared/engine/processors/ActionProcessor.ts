...
export class ActionProcessor {
  ...
  async processRoleMeeting(ctx: WeekContext, action: GameEngineAction, dbTransaction?: any): Promise<void> {
    ...
    if (choice.effects_immediate) {
      ...
      // Engine-verbs arc: structured-value effects ride along un-scaled (the mood
      // transform passes non-numbers through anyway; keeping them out of
      // appliedEffects keeps the badge record purely numeric).
