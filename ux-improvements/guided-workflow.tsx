                    ...
                    className={`flex items-center space-x-2 px-3 py-1 rounded-full text-sm transition-all ${
                      isCurrent 
                        ...
                        : isCompleted || isPast
                          ...
                          : 'bg-brand-purple-light/20 text-white/50'
                    }`}
                  >
                    {isCompleted || isPast ? (
...
function HelpTooltip({ content }) {
  return (
    <div className="inline-flex items-center justify-center w-5 h-5 bg-brand-purple-light/30 rounded-full text-xs text-white/70 cursor-help">
      ?
    </div>
  );
}