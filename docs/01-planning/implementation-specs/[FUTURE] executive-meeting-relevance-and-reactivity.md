...
> **Status:** HISTORICAL — problem framing fully resolved. **Tier 0+1 EXECUTED July 5, 2026** (PRs #122–#124, `COMPLETED/[COMPLETE] meeting-relevance-tier0-1-plan.md`); **Tier 2 + side events EXECUTED July 5, 2026, same evening** (PRs #133–#139, `COMPLETED/[COMPLETE] tier2-reactive-meetings-and-side-events-plan.md` — reactive meetings with why-now lines + urgency dots, side events surfaced as the WeekSummary beat, mood phases 6–10 dispositioned via fork E). Every tier of the scope fork below is now shipped; this doc remains as design rationale only. Note: the golden-master caution in "Constraints" below turned out not to apply — selection lives in the roles route, outside the advance-week engine path.
