...
*One entry per open product/strategy decision. Updated in place (resolved entries are deleted, not struck). Last updated: July 5, 2026 (merge day + meeting-relevance Tier 0+1 arc; former §7 C74 — header AUTO review-gate bypass — resolved and removed: Nes chose to elevate the review panel to the header AUTO button, the old direct-commit path was removed, and the same slice fixed AUTO proposing the A&R exec while the office slot was in use).*
