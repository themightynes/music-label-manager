...
*One entry per open product/strategy decision. Updated in place (resolved entries are deleted, not struck). Last updated: July 6, 2026, late evening (former §2 Buzz-v2 hype arc RESOLVED — Nes decided all six forks per recommendation, arc scheduled; former §3 C43 RESOLVED via its fork E — cancel UI ships in the hype arc. Remaining open: C32 email cap, desktop GUI, C62 sub-item semantics).*
