...
### [ ] Comment 99 (C99): DialogueInterface choice-preview badges assume numeric effect values — structured keys would render garbage if authored 🔵
**Priority**: 🔵 Low
