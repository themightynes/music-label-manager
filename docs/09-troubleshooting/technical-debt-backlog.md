...
- **Completed**: 96 — C62 (AchievementsEngine scoring) fully RESOLVED July 27, 2026: its last sub-item `projectsCompleted` settled — designer ruled it does NOT contribute to the campaign score, REMOVED from the scorer and replaced by a NON-SCORING "By the Numbers" career-stats readout (singles/EPs/albums released, single shows, tours; recording sessions excluded); combined with `artistsSuccessful` (wired earlier this session = `popularity >= 70`, 5 pts, scored) C62 is done; C55 (email-generation swallow) + C108 (processWeeklyCharts swallow) resolved July 26, 2026 by the single PENDING-DECISIONS #11 ruling (log-and-continue, gameplay-first; same swallow-class): C55's `emailGenerationFailed` flag now surfaced as a non-blocking WeekSummary notice; C108 log-and-continue PLUS recoverable chart milestones (fire on current position OR persisted peakPosition, golden-master-safe — 26/26 unchanged); C107 (cancel-release awareness over-zeroing scoped to UNRELEASED songs via ordered zero-then-unlink; shipped lead single keeps its live earned awareness/peak) + C109 (rngSeed resolved-and-persisted on first use, so the `Math.random()` fallback can never fire twice) + C110 (layering-safe `DbOrTx` type replaces all 113 `dbTransaction?: any` across 12 files, tsc clean) resolved July 26, 2026; C96 (why-now noticed-ness, "Amplify in place" ruling #16: bigger/louder urgency dot + ping halo, amplified why-now pill, shared WhyNowLine consolidation) resolved July 25, 2026, evening; C95 (zero-awareness Buzz stays hidden by design, ruling #15) resolved July 25, 2026, evening; C61 (copy-tone ruling #12 + helpTopics guide fix) + C89 (same-loyalty-by-design ruling #13) resolved July 25, 2026, evening (Group-A pending-decisions pass; #20 Buyout gate 440 same pass — its code half was C106, already complete); 16 resolved July 25, 2026 by the debt-cleanup session (branch `debt/cleanup-2026-07-25`): C50 (vitest project split) + C77 (=== cadence fixture) + C66-partial (log gating + backup untracked) `6924597`; C52 + C53 (v2 token/dead-code/container sweep) `ee8a822` + `b46e2b0`; C56 (`useSyncExternalStoreWithSelector`) + C57 (cold-cache guard + dev warn) + C82 (knob tripwire) + C106 (0-700 admin sweep; Buyout-Letter gate → PENDING-DECISIONS #20) `b46e2b0`; C75 (remaining-CC gate) `0852cb4`; C83 (lead-single refund share) `b32e1af`; C80 (structured awareness fields) + C81 (hype twin-entry fold) `2f00a4e`; C102 (spawn_release budget deduction) + C105 (schedule_event dedupe) `195f0da`; C59 (21-item triage → C108–C110 promoted) + C84 (Buzz-v2 docs sync) in the session's docs pass; previously: C99 (DialogueInterface structured-badge landmine — qualitative number-free badges for structured/misleading-numeric effect keys) resolved July 20, 2026 on `content/meeting-content-session`; C91 (self-serving hint sweep) resolved July 12, 2026 by the v2 stakes-revision content pass; C92 (outcome_summary schema + renderers, `52a9682`), C93 (flop ratio 0.10→0.30 per PENDING-DECISIONS #8, `ad155d8`, pending round-4 confirmation) + C94 (CC from chart milestones per #9, `2a74a24`; exec-pool/CEO-lane grants ride the v3 content wave) resolved July 12, 2026 on `content/meeting-content-session`; C65 (uncapped press rep) resolved July 11, 2026 by the volatility-economy arc (PR #161); C76 + C85 + C86 + C87 resolved July 11, 2026 by the small-ready-slices arc (`feat/small-ready-slices`: C87 tour energy drain `e1a543f`, C86 four additive GM fixtures `fbbcc53`, C76 audit/negotiate retune `b56a968`, C85 four new guide topics `7f007c2`); C79 (awareness dead-config spots) resolved July 10, 2026 by the balance-integrity arc slice 1 (knob liberation, commit `f065637`)
- **Deferred by decision**: 4 (C32; C42 — decided July 6, 2026: wire awareness fully player-facing; build EXECUTED same evening on `feat/awareness-surfacing`, held with PR #149 pending playtest; C43; C104 — decided July 25, 2026, evening: physical sales deferred entirely per PENDING-DECISIONS #10 ruling, the two `grant_inventory` scenarios removed from the v3 pools and preserved in `implementation-specs/[FUTURE] physical-inventory-system.md`, retune gate rides the reactivation checklist)
- **In Progress**: 0
- **Pending**: 10 (C62 fully RESOLVED July 27, 2026 — see Completed; C63 — partial: phantom loyalty fallbacks removed `b46e2b0`, dead columns dropped `0022`, massAppeal WIRE promoted July 27, 2026 to `implementation-specs/[FUTURE] massappeal-artist-reach.md` and removed from the active PENDING-DECISIONS queue (stays pending-partial); C66 — partial: log gating + backup done `6924597`, loose-schema tightening remains; C78 — tour-tier1 session find, July 6, 2026; C88 (marketing attribution) promoted July 27, 2026 to `implementation-specs/[FUTURE] marketing-attribution.md` and removed from the active PENDING-DECISIONS queue (stays pending/deferred); C90, C100 — removed from the active PENDING-DECISIONS queue July 27, 2026 (content-gated; resolve when the v3 content wave needs them), stay pending here; C97 + C98 + C101 + C103 (narrowed July 25, 2026: part (2) false since `2063f68` — 3 verdict events + 3 authored schedule_event effects are live; singleton escalation pools remain) — BLOCKED-ON-CONTENT-WAVE) — C55 + C108 resolved July 26, 2026 by the single PENDING-DECISIONS #11 ruling (log-and-continue; see Completed); C107 + C109 + C110 resolved July 26, 2026 (see Completed); C50 + C52 + C53 + C56 + C57 + C59 + C75 + C77 + C80 + C81 + C82 + C83 + C84 + C102 + C105 + C106 resolved July 25, 2026 (debt-cleanup session, see Completed); C91 (v2 stakes-revision hint sweep) + C92 (outcome_summary schema) + C93 (#8 flop ratio) + C94 (#9 CC milestones) resolved July 12, 2026 on `content/meeting-content-session`; C70 (PR #128) + C72 (PR #129) + C73 (PR #130) resolved July 5, 2026 (evening debt-pile pass); C64 (seeded side-event selection) resolved July 5, 2026 (PR #138, Tier 2 MVP-2); C67 (`071c6df`) + C68 (`5b44d9e`) + C69 (`1db5c39`) resolved July 4, 2026 on PR #119; C51 (`6e945e3`) + C58 (`3d8066a`) + C60 (`7898de6`) + C62-partial (`f1b1315`) resolved July 4, 2026 on PR #120; C71 (reference-doc sync) resolved July 5, 2026 in the post-merge docs pass; C74 (header AUTO review-gate + AR-busy AUTO fix) resolved July 5, 2026; C79 (awareness dead-config spots) resolved July 10, 2026 by the balance-integrity arc slice 1
...
> 🧪 **Test-infra note (July 26, 2026)**: the long-documented `tests/endpoints/route-manifest.test.ts` `/mnt/c` WSL timeout flake was fixed this session — the manifest tests now carry an explicit 30s `it` timeout, since the cold `server/routes` import exceeds vitest's 5s default on the WSL filesystem. The committed manifest snapshot was verified byte-identical (no drift). Not a numbered ledger item.
...
### [x] ~~Comment 55: Engine silently swallows email-creation errors during week advance~~ ✅ RESOLVED
**Status**: ✅ **RESOLVED** (July 26, 2026) — settled together with C108 by the single PENDING-DECISIONS #11 ruling (Nes, gameplay-first: log-and-continue for both, same swallow-class). No rethrow: the week keeps committing on an email-generation failure. The `summary.emailGenerationFailed` flag (shipped `195f0da`, typed on `WeekSummary`) is now SURFACED in the WeekSummary UI as a subtle non-blocking notice (`client/src/components/WeekSummary.tsx`), so the swallowed failure is player-visible without interrupting the advance. Earlier safe slice (July 25, 2026, `debt/cleanup-2026-07-25`): the flag itself set when email generation/persist throws (`shared/engine/game-engine.ts:661`). Verified this session: tsc clean; golden master 26/26 unchanged; new tests pass.
**Priority**: 🔵 Low
...
### [x] Comment 61: Access-tier downgrades announce "Upgraded"; drop to `none` announces nothing 🔵
**Status**: ✅ **RESOLVED** (July 25, 2026, evening — PENDING-DECISIONS #12 ruling): Nes ruled the shipped neutral/factual downgrade-loss copy **final** ("… Access Downgraded" / "… Access Lost"), closing the remaining copy-tone scope with zero string changes; the flagged doc-sync loose end — the Label Head's Guide "Access" veteran note claiming a door can "quietly close" — was fixed in the same pass (`client/src/lib/helpTopics.ts`: the close is now described as announced). Mechanics half earlier: 🔶 (July 25, 2026, branch `debt/cleanup-2026-07-25`, commit `195f0da`) — the lie is fixed: tier notifications are direction-aware. Downgrades say "… Access Downgraded", a drop to `none` says "… Access Lost" (both `type: 'reputation'`, so no phantom tier-unlock email), gated on the new `gameState.tierUnlockHistory` so only access the player was previously TOLD they gained announces its loss (pre-existing GM fixtures with unearned seeded tiers stay silent; upgrade path byte-identical, golden master unchanged 26/26). Newly relevant since PR #174 made reputation losses ×3. **Copy-tone scope closed** (July 25, 2026, evening): the downgrade/loss strings — previously flagged as neutral/factual placeholder-quality pending `docs/01-planning/PENDING-DECISIONS.md` #12 — were ruled final as-is; no further string work. Doc-sync closed (same pass): the Label Head's Guide "Access" topic (`client/src/lib/helpTopics.ts`) had said a slipping label can "watch a door quietly close on it" — post-C61 the close is announced, and the guide line now says so; `game-system-workflows.md`'s tier section WAS updated earlier (direction-aware flow + 0-700 thresholds).
**Priority**: 🔵 Low
...
### [x] ~~Comment 62: AchievementsEngine — two score components hardcoded 0, Media Mogul checks mid-tiers with `===`, "12 weeks" copy rot~~ ✅ RESOLVED 🟢
**Status**: ✅ **RESOLVED** (July 27, 2026) — the last remaining sub-item (`projectsCompleted`) is settled. Designer ruling: `projectsCompleted` does NOT contribute to the campaign score. It was REMOVED from the scorer entirely (no longer hardcoded 0 as a score component) and replaced by a NON-SCORING "By the Numbers" career-stats readout on the results screen: # singles / EPs / albums released; # single shows (1-city Mini-Tours); # tours (multi-city); recording sessions excluded. Combined with `artistsSuccessful` (defined + wired earlier this session = `popularity >= 70`, 5 pts each into `finalScore`, scored), C62 is now fully done.
**Priority**: 🟢 Medium
...
**🔶 PARTIALLY FIXED (commit `f1b1315`, July 4, 2026, on `feat/session-fixes-legibility-emails`/PR #120):** sub-items (2) and (3) resolved — Media Mogul now requires the true maxima (`flagship`/`national` per `progression.json`), and both 12-week strings say 52 weeks (HARDCODED: comments; the engine only receives the `gameState` row, not balance config). Sub-item (1) — the zeroed `artistsSuccessful`/`projectsCompleted` — remains open BY DESIGN: no doc defines the success/completion semantics, and `calculateCampaignResults` receives only `gameState` (no artist/project data), so implementing it needs a design decision + call-site plumbing (see `docs/01-planning/PENDING-DECISIONS.md`). Expanded TODO left at the site. +6 tests in `tests/engine/achievements-engine.test.ts`. **UPDATE (July 26, 2026, branch `debt/docs-hygiene-and-correctness-cluster-2026-07-26`):** sub-item (1)'s `artistsSuccessful` is now DEFINED + WIRED — designer ruling set a *successful artist* = `popularity >= 70`, **5 pts each into `finalScore`**, both knobs in `progression.json` `campaign_scoring`; the scorer takes an optional `artists[]` and `ProgressionProcessor.checkCampaignCompletion` loads it via `ctx.storage.getArtistsByGame`. Golden master re-blessed (dead-column drop only — no scoring drift, since no fixture reaches campaign completion). **Remaining scope = `projectsCompleted` only** (still hardcoded 0; recommended def `stage === 'released' || completionStatus === 'completed'` @ ~2 pts — see PENDING-DECISIONS C62 item). **UPDATE (July 27, 2026 — RESOLVED):** designer ruled `projectsCompleted` does NOT contribute to the campaign score. It was REMOVED from the scorer entirely and replaced by a NON-SCORING "By the Numbers" career-stats readout on the results screen (# singles / EPs / albums released; # single shows = 1-city Mini-Tours; # tours = multi-city; recording sessions excluded). C62 is now fully resolved.
...
**Status**: 🔶 **PARTIALLY RESOLVED** (July 25, 2026, branch `debt/cleanup-2026-07-25`, commit `b46e2b0`) — safe slice shipped: the unreachable `(artist as any).loyalty` client fallbacks are gone (4 sites; zero-readers re-verified July 25). **UPDATE (July 26, 2026, branch `debt/docs-hygiene-and-correctness-cluster-2026-07-26`):** the drop decision is made — the 5 fully-dead columns (`stress`/`creativity`/`moodHistory`/`lastMoodEvent`/`moodTrend`) are DROPPED via migration `0022_drop_dead_artist_mood_columns.sql` (schema.ts + `migrations/schema.ts` mirror + test factories updated). **No `SNAPSHOT_VERSION` bump needed** — restore is a Drizzle insert that silently ignores keys absent from the schema (verified against Drizzle source), so existing v2 saves still restore; the dead-column data is harmlessly dropped. Golden master re-blessed (dead-key removal only). `massAppeal` is RETAINED to be wired later. **Remaining scope = the `massAppeal` wire decision** — **promoted July 27, 2026 to `docs/01-planning/implementation-specs/[FUTURE] massappeal-artist-reach.md` and REMOVED from the active PENDING-DECISIONS queue (was #19).** C63 stays pending-partial here. The phantom `artist.loyalty` fallbacks were already removed (`b46e2b0`).
**Priority**: 🔵 Low
...
**Status**: ⏸️ **BLOCKED ON DESIGN DECISION** (triaged July 25, 2026, debt-cleanup session) — needs a definition of the attribution model (which streams/revenue count as marketing-driven) before any build. Defer cost: the loss-leader view stays qualitative. **UPDATE (July 27, 2026):** promoted to `docs/01-planning/implementation-specs/[FUTURE] marketing-attribution.md` (research captured there: 3 attribution models, channel-tagged v1 recommendation, and the fork-E no-numbers policy blocker) and REMOVED from the active PENDING-DECISIONS queue (was #18). Stays a pending/deferred item here.
**Priority**: 🔵 Low
...
### [x] Comment 89 (C89): AUTO-endorse vs. manual are server-indistinguishable — `auto_endorse_loyalty_gain` is a reserved dead knob 🔵
**Status**: ✅ **RESOLVED BY DESIGN** (July 25, 2026, evening — PENDING-DECISIONS #13 ruling): AUTO-endorse and personal picks grant the SAME loyalty (both knobs stay at 5) **intentionally** — AUTO already pays its own costs (CC budget, review gate), so it isn't taxed twice. `auto_endorse_loyalty_gain` stays in `progression.json` as a reserved future tuning lever; the `autoEndorsed`-marker plumbing stays unbuilt unless a future ruling picks a differing value (re-open as a NEW C-item if so). No code changed.
**Priority**: 🔵 Low
...
**Status**: ⏸️ **BLOCKED ON DESIGN DECISION** (triaged July 25, 2026, debt-cleanup session) — the mechanism is agent-buildable (reuse the M16 grammar), but the canonical precondition vocabulary needs the designer's call. Defer cost: low — the ad-hoc `crisis_fired_dancers` filter holds today. **UPDATE (July 27, 2026):** removed from the active PENDING-DECISIONS queue (was #14) — content-gated; resolve when the v3 content wave needs it. Stays pending here.
**Priority**: 🔵 Low
...
### [x] Comment 92 (C92): meeting choices have no authored past-tense "outcome summary" for the digest/results surfaces 🔵 — **RESOLVED 2026-07-12 (schema + renderers landed, `content/meeting-content-session` `52a9682`; authoring rides the v3 content wave)**

**Resolution**: the additive optional `outcome_summary` field landed on the choice schema (`shared/api/contracts.ts:442`, `z.string().min(1).optional()`) with fallback-to-`label` reads at the render sites (`client/src/components/WeekSummary.tsx:268` `choice.outcome_summary ?? choice.label`) and a dedicated editor field in ActionsViewer (`client/src/admin/ActionsViewer.tsx:1787-1798`, showing "— falls back to label —" when unset). The per-choice authoring pass itself is deliberately NOT a backfill of the current pool — the v3 ground-up rewrite (98 scenarios in the 7-pool review surface) authors summaries as part of the content-integration wave instead.
**Priority**: 🔵 Low
...
### [x] Comment 93 (C93): flop trigger practically unreachable in competent play 🟡 — **RESOLVED 2026-07-12 (PENDING-DECISIONS #8 decided: `flop_revenue_ratio` 0.10 → 0.30, `content/meeting-content-session` `ad155d8`; pending round-4 playtest confirmation that the flop actually fires)**

**Resolution**: Nes decided option 1 of #8 (raise the ratio — cheapest, pure config, no code change): `flop_revenue_ratio` raised 0.10 → 0.30 in `data/balance/progression.json` `reputation_system`; `flop_investment_floor` unchanged at 10000. Config-only — the trigger check in `ReleaseProcessor.processPlannedReleases` is untouched. The proof this makes the flop reachable in competent play is a round-4 playtest observation, still outstanding.
**Priority**: 🟡 High
...
### [x] Comment 94 (C94): Creative Capital has exactly one positive source 🟡 — **RESOLVED 2026-07-12 (PENDING-DECISIONS #9 decided: ALL THREE sources; chart milestones shipped, `content/meeting-content-session` `2a74a24`; exec-pool + CEO-lane grants land with the v3 content wave)**

**Resolution**: Nes decided all three #9 options as complementary. **Live now:** CC from chart milestones — `applyChartMilestoneBonuses` grants CC alongside the existing milestone bonuses (once per song, no-stack; knobs `progression.json` `reputation_system.creative_capital_milestones.cc_top10_bonus`/`cc_number_one_bonus`; systems-map edge `e-chart-creative-capital` added in-slice). **Pending (content, not mechanism):** CC-granting choices spread across the exec pool and the CEO lane are authored into the v3 scenarios and ship with the content-integration wave — no further engine work needed.
**Priority**: 🟡 High
...
### [x] Comment 95 (C95): release Buzz section hidden at zero awareness during the weeks-1–4 building window 🔵
**Status**: ✅ **RESOLVED BY DESIGN** (July 25, 2026, evening — PENDING-DECISIONS #15 ruling): Nes ruled the zero-awareness Buzz section stays HIDDEN — hiding is intended behavior, not a gap. The always-render "building" state does NOT ship; the scaffolding in `releaseBuzz.ts` remains available if a future playtest reopens this (re-open as a NEW C-item if so). Closes the round-2/round-3 carried-forward playtest confusion item as accepted. No code changed.
**Priority**: 🔵 Low
...
### [x] Comment 96 (C96): reactive-meeting "why now" line has low noticed-ness 🔵
**Status**: ✅ **RESOLVED** (July 25, 2026, evening — PENDING-DECISIONS #16 ruling "Amplify in place"): urgency dot 10px→14px with an animate-ping halo + stronger glow (both ExecutiveCard sites), reactive strip glow alpha 0.16→0.32, why-now pill 11.5px→13.5px with doubled border/bg opacity and whole-pill pulse, and the AutoSelectReviewPanel's hand-duplicated pill consolidated onto the shared WhyNowLine (compact variant). Layout/copy/spoiler stance unchanged. Visually APPROVED by Nes same evening (live review over Tailscale on the fresh dev build); in-play noticed-ness confirmation still rides the next playtest.
**Priority**: 🔵 Low
...
**Effort**: Small–Medium (one systems-map node/edge/knob pass + one help-topic paragraph, after the content wave decides which verbs ship in scenarios).
...
**Relevant Files**:
- [client/src/admin/ActionsViewer.tsx](client/src/admin/ActionsViewer.tsx) (lines 1847, 1876, 1931, 1956)
- [client/src/admin/SideEventsEditor.tsx](client/src/admin/SideEventsEditor.tsx) (lines 1010, 1080)
- [shared/engine/processors/ActionProcessor.ts](shared/engine/processors/ActionProcessor.ts) (STRUCTURED_EFFECT_KEYS, :147)

*Identified July 12, 2026 during the engine-verbs session-end doc-sync pass.*

---

### [x] Comment 99 (C99): DialogueInterface choice-preview badges assume numeric effect values — structured keys would render garbage if authored 🔵 — **RESOLVED 2026-07-20 (`content/meeting-content-session`)**
**Priority**: 🔵 Low
**Impact**: `EffectBadge` in the player-facing meeting dialogue types its `value` as `number` and every formatter branch does numeric math/sign formatting (`client/src/components/executive-meetings/DialogueInterface.tsx:42-124`); the `default:` fallback renders `` `${val > 0 ? '+' : ''}${val} ${key}` ``. The seven structured keys ARE members of `LIVE_EFFECT_KEYS`, so the badge-honesty filter (render only `LIVE_EFFECT_KEYS ∪ {executive_mood}`) admits them — the moment the v3 wave authors a `schedule_event`/`grant_song`/`story_flag`/etc. onto a meeting choice, the preview badge would render something like `[object Object] schedule event`. Zero player impact today (no structured key is authored in `data/actions.json`), but this is a landmine directly in the content wave's path.
**Effort**: Small (either per-key qualitative badge copy — "Sets events in motion", "Grants a recorded song" — mirroring `EFFECT_CHANNEL_DESCRIPTIONS`, or filter structured keys out of the badge row until authored copy exists; extend `DialogueInterface.badges.test.tsx`)

**Relevant Files**:
- [client/src/components/executive-meetings/DialogueInterface.tsx](client/src/components/executive-meetings/DialogueInterface.tsx) (EffectBadge, :42-135; default case :119-123)
- [client/src/components/executive-meetings/__tests__/DialogueInterface.badges.test.tsx](client/src/components/executive-meetings/__tests__/DialogueInterface.badges.test.tsx)

**Resolution**: `EffectBadge`'s `value` prop is retyped from `number` to `EffectValue` (`number | string | boolean | object | null`), and a qualitative rendering path added ahead of the numeric switch. Two key families now render a number-free channel badge — label sourced from `EFFECT_CHANNEL_DESCRIPTIONS[key].title`, full copy already carried by the existing `EffectBadgeTooltip`: (1) all seven `STRUCTURED_EFFECT_KEYS` (object/string values), and (2) the misleading-numeric verbs `press_scrutiny_flag`, `promote_release`, `catalog_damage`, `cancel_project`, `grant_inventory`, `transfer_revenue_stream` (raw magnitude/fraction would leak an internal knob — fork-E). The qualitative branch never interpolates the value, so `schedule_event`'s target `event_id` can never surface on the badge or in the DOM. Adverse channels (`set_exec_absence`, `press_scrutiny_flag`, `catalog_damage`, `cancel_project`, `transfer_revenue_stream`) color `text-negative`; the rest use a neutral `text-neon-cyan` v2 treatment (no inline hex). Numeric channels render byte-identically to before. Badges now read: `schedule_event`→"Consequence", `story_flag`→"Story", `spawn_prospect`→"New Prospect", `set_exec_absence`→"Exec Away", `distribution_efficiency`→"Distribution", `grant_song`→"New Recording", `spawn_release`→"Surprise Release", `press_scrutiny_flag`→"Press Scrutiny", `promote_release`→"Catalog Push", `catalog_damage`→"Catalog Hit", `cancel_project`→"Project Shutdown", `grant_inventory`→"Physical Pressing", `transfer_revenue_stream`→"Catalog Share Sale". `DialogueInterface.badges.test.tsx` extended with structured/object-value, no-`[object Object]`, no-`event_id`-leak, misleading-numeric, and numeric-unchanged coverage (36 tests pass; `npm run check` clean).

*Identified July 12, 2026 during the engine-verbs session-end doc-sync pass. Resolved July 20, 2026 on `content/meeting-content-session`.*
...
**Status**: ⏸️ **BLOCKED ON DESIGN DECISION** (triaged July 25, 2026, debt-cleanup session) — accept-and-document vs. snapshot fetch-time money; dormant while zero cash-gated content exists. **UPDATE (July 27, 2026):** removed from the active PENDING-DECISIONS queue (was #17) — content-gated; resolve when the v3 content wave needs it. Stays pending here.
**Priority**: 🔵 Low
...
**Relevant Files**:
- [shared/engine/game-engine.ts](shared/engine/game-engine.ts) (NOTE comment, :791-800)
- [shared/engine/meetingSelection.ts](shared/engine/meetingSelection.ts) (buildRelevanceInput two-site lockstep helper, :165-192)
- [tests/engine/meeting-selection-two-site-parity.test.ts](tests/engine/meeting-selection-two-site-parity.test.ts)

*Identified July 12, 2026 during the engine-verbs session-end doc-sync pass (the drift is by design and comment-documented at the site; logged so the cash-gated content wave finds it).*
...
**Relevant Files**:
- [docs/01-planning/implementation-specs/COMPLETED/[COMPLETE] engine-verbs-plan.md](../01-planning/implementation-specs/COMPLETED/[COMPLETE]%20engine-verbs-plan.md) (Deferred section)
- [shared/engine/game-engine.ts](shared/engine/game-engine.ts) (M14 TODO, :1008-1017)

*Logged July 12, 2026 during the engine-verbs session-end doc-sync pass (one grouped entry, per the completion header).*
...
**Relevant Files**:
- [shared/engine/processors/ActionProcessor.ts](shared/engine/processors/ActionProcessor.ts) (spawn_release path, HARDCODED note :2067-2069)
...
**Relevant Files**:
- [data/events.json](data/events.json) (the 4 singleton escalation stubs; no scheduled_only events yet)
- [shared/utils/executiveDelegation.ts](shared/utils/executiveDelegation.ts) (ESCALATION_EVENT_BY_ROLE, :114-119)
- [client/src/admin/v3EscalationsPoolReview.ts](client/src/admin/v3EscalationsPoolReview.ts) (the authored-pending-review scenarios)

*Identified July 12, 2026 during the engine-verbs session-end doc-sync pass (content-wave dependency, not an engine gap).*
...
**Status**: ⏸️ **DEFERRED BY DECISION** (July 25, 2026, evening — PENDING-DECISIONS #10 ruling): Nes ruled to **defer physical sales entirely** rather than retune, mooting the knob question and clearing the content-wave HARD BLOCKER. The two v3 scenarios that wired `grant_inventory` (`physical_media_bet`, Pat; `the_loudness_heresy`, Dante) were removed from the pool review modules + `POOL_REVIEW_MEETING_IDS` + pinned pool counts, and preserved verbatim — with the money-printer analysis, candidate retune math, and a reactivation checklist — in `docs/01-planning/implementation-specs/[FUTURE] physical-inventory-system.md`. The retune remains a mandatory gate at reactivation (the [FUTURE] doc §6 checklist), guarded by the soft lint. Earlier same day (`2f00a4e`): the "unlinted" half closed — the soft data-lint (`tests/engine/data-lint-content-dead-verbs.test.ts`) pins the 7 content-dead verbs (`cancel_project`, `catalog_damage`, `distribution_efficiency`, `grant_inventory`, `press_scrutiny_flag`, `set_exec_absence`, `transfer_revenue_stream`) — pin drift fails, so `grant_inventory` content cannot slip in unnoticed, with the retune blocker documented at the pin.
...
**Relevant Files**:
- [data/balance/markets.json](data/balance/markets.json) (physical_inventory block, :276-285)
- [shared/engine/flagsLedgers.ts](shared/engine/flagsLedgers.ts) (PHYSICAL_INVENTORY_DEFAULTS :64-72; processInventoryWeek :139-190)
- [shared/engine/processors/ActionProcessor.ts](shared/engine/processors/ActionProcessor.ts) (grant_inventory case, :2284-2359)

*Identified July 21, 2026 during the meeting-content-session code review (F2). Knob values verified against markets.json + flagsLedgers.ts.*
...
**Relevant Files**:
- [shared/engine/processors/ActionProcessor.ts](shared/engine/processors/ActionProcessor.ts) (schedule_event case, :1020-1057)
- [shared/engine/game-engine.ts](shared/engine/game-engine.ts) (promoteScheduledEvents :1058-1160; chained-verdict schedule :1773-1780)
- [data/actions.json](data/actions.json) (machine_that_listens, :1388; stake_mac_against_it choice)

*Identified July 21, 2026 during the meeting-content-session code review (F7).*

---

### [x] ~~Comment 106 (C106): admin systems-map + review-tool strings still describe the retired 0-100 reputation scale~~ ✅ RESOLVED 🔵
**Status**: ✅ **RESOLVED** (July 25, 2026, branch `debt/cleanup-2026-07-25`, commit `b46e2b0`) — string sweep done: `systemsMapData.ts`'s reputation node prose moved to 0-700 and the sellThrough formula display corrected `/100` → `/700`. **Designer note closed** (July 25, 2026, evening — PENDING-DECISIONS #20 ruling): the Buyout Letter gate rescaled `reputation >= 60` → **`>= 440`** (0-700 scale, national-press-tier anchor; the week-40 gate stays the real limiter) — annotation updated in `v3CeoPoolReview.ts`.
...
**Relevant Files**:
- [client/src/admin/systemsMapData.ts](client/src/admin/systemsMapData.ts)
- [client/src/admin/v3CeoPoolReview.ts](client/src/admin/v3CeoPoolReview.ts) (and sibling v3 review/feedback files)

*Identified July 25, 2026 during the round-4 reputation rescale (PR #174).*

---

### [x] ~~Comment 107 (C107): cancel-release zeroes awareness/peak_awareness for ALL songs on the release — including an already-shipped lead single~~ ✅ RESOLVED 🟢
**Status**: ✅ **RESOLVED** (July 26, 2026) — `deleteRelease` now scopes the awareness/`peak_awareness` zeroing to UNRELEASED songs (`is_released = false`) via two ORDERED updates (zero-then-unlink): the zeroing update filters on `is_released = false`, then a second update unlinks ALL songs on the release (`releaseId → null`). A shipped lead single therefore keeps its live earned `awareness`/`peak_awareness` (and its streaming multiplier + historical peak) while still being unlinked, so the deleted release row leaves no dangling FK. Pinned by endpoint test `tests/endpoints/delete-release-shipped-lead-single.test.ts`.
**Priority**: 🟢 Medium
...
### [x] ~~Comment 108 (C108): `processWeeklyCharts` swallows all errors — a week can commit without chart rows~~ ✅ RESOLVED 🟢
**Status**: ✅ **RESOLVED** (July 26, 2026) — settled together with C55 by the single PENDING-DECISIONS #11 ruling (Nes, gameplay-first: log-and-continue for both, same swallow-class). No rethrow: a chart failure keeps the week committed, with the `summary.chartGenerationFailed` flag surfacing it. Beyond the flag slice, the ruling added RECOVERABLE milestones: `applyChartMilestoneBonuses` now fires on the current chart position OR the persisted `peakPosition` (flag-guarded), so a milestone grant skipped by a fetch/apply-stage chart failure is re-attempted and granted on the next successful advance; only generation-stage failures (no rows written) remain genuinely unrecoverable. Golden-master-safe: the recovery adds zero grants in normal play, so golden master 26/26 is unchanged. New test `tests/engine/chart-milestone-recovery.test.ts` (plus the earlier flag test `tests/engine/chart-generation-failure-flag.test.ts`). Verified this session: tsc clean; golden master 26/26 unchanged; new tests pass.
**Priority**: 🟢 Medium
...
### [x] ~~Comment 109 (C109): `rngSeed` falls back to `Math.random()` inside the advance-week service — nondeterminism for seedless rows~~ ✅ RESOLVED 🔵
**Status**: ✅ **RESOLVED** (July 26, 2026) — `advanceWeekService` now resolves the seed once and PERSISTS it on first use (`tx.update(gameStates)`), so the `Math.random()` fallback can never fire twice: a seedless row gets a fresh seed written back on its first advance and advances identically thereafter. Already-seeded rows are behavior-identical (no extra write, golden master unaffected). Test: `tests/features/advance-week-rng-seed-persistence.test.ts`.
**Priority**: 🔵 Low
...
### [x] ~~Comment 110 (C110): `dbTransaction?: any` across storage/engine (~113 occurrences) — no compile-time protection against dropped transactions~~ ✅ RESOLVED 🔵
**Status**: ✅ **RESOLVED** (July 26, 2026) — new `shared/types/db.ts` defines a layering-safe DERIVED `DbOrTx` type (`Database | DbTransaction`, importing only `drizzle-orm` + `@shared/schema` — no server import, so the shared tier stays clean); all 113 `dbTransaction?: any` occurrences across 12 files were replaced with `dbTransaction?: DbOrTx`; `tsc` clean. The stronger typing surfaced a few typed-read spots (e.g. `ProjectStageProcessor` metadata/`artistId`) fixed mechanically with the codebase's existing `as any`/null-handling patterns — no behavior change; golden master 26/26 unchanged.
**Priority**: 🔵 Low
...
- 🟢 Medium: 2 deferred (C42 — decided July 6, 2026: wire awareness fully player-facing, build queued; C43 — product decision open, July 3, 2026; see stale-entry corrections in Document Information), 0 pending — C62 fully RESOLVED July 27, 2026 (`projectsCompleted` ruled NON-scoring: removed from the scorer, replaced by a non-scoring "By the Numbers" career-stats readout; `artistsSuccessful` defined + wired July 26, 2026 = `popularity >= 70`, 5 pts into finalScore) — C108 (processWeeklyCharts error swallow) resolved July 26, 2026 by PENDING-DECISIONS #11 (log-and-continue + recoverable chart milestones, golden-master-safe); C107 (cancel-release awareness over-zeroing scoped to unreleased songs) resolved July 26, 2026; C105 (schedule_event dedupe) resolved July 25, 2026 (`195f0da`); C67 + C68 + C69 resolved July 4, 2026 (PR #119); C58 (stale-week guard) + C60 (delayed-effect targeting) + C62's other sub-items resolved July 4, 2026 (PR #120); C74 (header AUTO review-gate bypass + AR-busy AUTO fix) resolved July 5, 2026
- 🔵 Low: 2 deferred (C32 — cap unreachable; surfacing fixed; C104 — physical sales deferred entirely July 25, 2026 evening per #10 ruling, scenarios preserved in `[FUTURE] physical-inventory-system.md`), 10 pending (C63 — partial, massAppeal WIRE promoted July 27, 2026 to `[FUTURE] massappeal-artist-reach.md`, removed from the active PENDING-DECISIONS queue; C66 — partial, loose-schema scope remains; C78 — venue-name map duplication, July 6, 2026; C88 — marketing attribution promoted July 27, 2026 to `[FUTURE] marketing-attribution.md`, removed from the active PENDING-DECISIONS queue; C90, C100 — removed from the active PENDING-DECISIONS queue July 27, 2026 (content-gated); C97, C98, C101, C103 (narrowed to singleton escalation pools) — BLOCKED-ON-CONTENT-WAVE) — C55 (email-generation swallow) resolved July 26, 2026 by PENDING-DECISIONS #11 (log-and-continue; flag surfaced in WeekSummary UI); C109 (rngSeed persisted on first use) + C110 (`DbOrTx` type replaces 113 `dbTransaction?: any`) resolved July 26, 2026; C96 (why-now noticed-ness, "Amplify in place" ruling #16) resolved July 25, 2026, evening; C95 (zero-awareness Buzz stays hidden by design) resolved July 25, 2026, evening (ruling #15); C61 + C89 resolved July 25, 2026, evening (Group-A rulings #12/#13); C50 + C52 + C53 + C56 + C57 + C59 + C75 + C77 + C80 + C81 + C82 + C83 + C84 + C102 + C106 resolved July 25, 2026 (debt-cleanup session); C91 (hint sweep) + C92 (outcome_summary schema) resolved July 12, 2026 on `content/meeting-content-session`; C51 ("On Tour" badge lag) resolved July 4, 2026 (PR #120); C71 (reference-doc staleness log) resolved July 5, 2026 (post-merge docs pass); C70 (12-week copy rot, PR #128) + C72–C73 (content-honesty warts, PRs #129–#130) resolved July 5, 2026 (evening debt-pile pass); C64 (seeded side-event selection) resolved July 5, 2026 (PR #138, Tier 2 MVP-2); C79 (awareness dead-config spots) resolved July 10, 2026 (balance-integrity arc slice 1)

### By Status
- ✅ Completed: 96 items (87.3% of 110; 96 + 4 deferred + 10 pending = 110 ✓) — C62 (AchievementsEngine scoring) fully RESOLVED July 27, 2026: last sub-item `projectsCompleted` ruled NON-scoring by the designer — removed from the scorer and replaced by a NON-SCORING "By the Numbers" career-stats readout (singles/EPs/albums released, single shows = 1-city Mini-Tours, tours = multi-city; recording sessions excluded); `artistsSuccessful` was defined + wired earlier this session (`popularity >= 70`, 5 pts, scored); C55 (email-generation swallow: log-and-continue, `emailGenerationFailed` flag surfaced as a non-blocking WeekSummary notice) + C108 (processWeeklyCharts swallow: log-and-continue + recoverable chart milestones that re-grant on the next successful advance, golden master 26/26 unchanged) resolved July 26, 2026, both settled by the single PENDING-DECISIONS #11 ruling (gameplay-first, same swallow-class); C107 (cancel-release awareness over-zeroing scoped to UNRELEASED songs via ordered zero-then-unlink; shipped lead single keeps its live earned awareness/peak) + C109 (rngSeed resolved-and-persisted on first use, `Math.random()` fallback can never fire twice) + C110 (layering-safe `DbOrTx` type replaces all 113 `dbTransaction?: any` across 12 files, tsc clean, golden master 26/26 unchanged) resolved July 26, 2026; C96 (why-now noticed-ness, "Amplify in place" ruling #16: louder urgency dot + ping halo, amplified why-now pill, shared WhyNowLine consolidation) resolved July 25, 2026, evening; C95 (zero-awareness Buzz stays hidden by design, ruling #15) resolved July 25, 2026, evening; C61 (copy-tone ruling #12 + helpTopics guide fix) + C89 (same-loyalty-by-design ruling #13) resolved July 25, 2026, evening (Group-A pending-decisions pass; #20 Buyout gate 440 same pass — its code half was C106, already complete); C50 + C52 + C53 + C56 + C57 + C59 + C75 + C77 + C80 + C81 + C82 + C83 + C84 + C102 + C105 + C106 resolved July 25, 2026 (debt-cleanup session, `debt/cleanup-2026-07-25`: `195f0da` C102/C105 + the C55/C61 safe slices, `b32e1af` C83, `b46e2b0` C53-dead-code/C56/C57/C82/C106 + the C63 safe slice, `0852cb4` C75, `6924597` C50/C77 + the C66 safe slice, `ee8a822` C52/C53-styling, `2f00a4e` C80/C81 + the C104 safe slice, docs pass C59/C84); C99 (DialogueInterface structured-badge landmine) resolved July 20, 2026 on `content/meeting-content-session`; C91 + C92 + C93 + C94 resolved July 12, 2026 (`content/meeting-content-session`: v2 stakes-revision hint sweep, outcome_summary schema `52a9682`, #8 flop ratio `ad155d8`, #9 CC milestones `2a74a24`); C65 resolved July 11, 2026 (volatility-economy arc, PR #161); C76 + C85 + C86 + C87 resolved July 11, 2026 (small-ready-slices arc)
- 🚧 In Progress: 0 items
- ⏸️ Deferred by decision: 4 items (C32; C42 — decided July 6, 2026: wire awareness fully player-facing (Nes); build EXECUTED same evening on `feat/awareness-surfacing`, held pending playtest; C43; C104 — decided July 25, 2026, evening (#10 ruling): physical sales deferred entirely, the two `grant_inventory` v3 scenarios removed and preserved in `implementation-specs/[FUTURE] physical-inventory-system.md`)
- 📋 Pending: 10 items (C62 fully RESOLVED July 27, 2026 — moved to Completed, see the Completed line; C63, C66 — PARTIALLY RESOLVED July 25, 2026, remaining scopes tracked at the entries (C63 massAppeal WIRE promoted July 27, 2026 to `[FUTURE] massappeal-artist-reach.md` and removed from the active PENDING-DECISIONS queue; C66 → loose-schema tightening); C104 — moved to Deferred-by-decision July 25, 2026 evening (#10 ruling: physical sales deferred entirely, see `[FUTURE] physical-inventory-system.md`); C78 — tour-tier1 find, July 6, 2026; C88 — marketing attribution promoted July 27, 2026 to `[FUTURE] marketing-attribution.md` and removed from the active PENDING-DECISIONS queue (stays pending/deferred); C90, C100 — removed from the active PENDING-DECISIONS queue July 27, 2026 (content-gated; resolve when the v3 content wave needs them), stay pending here; C97, C98, C101, C103 — BLOCKED-ON-CONTENT-WAVE, triaged July 25, 2026 (C103 narrowed: verdict/scheduled events ARE authored since `2063f68`; singleton escalation pools remain)). C55 + C108 resolved July 26, 2026 by the single PENDING-DECISIONS #11 ruling (log-and-continue; see Completed). C107 + C109 + C110 resolved July 26, 2026 (see Completed). C96 resolved July 25, 2026, evening (ruling #16 "Amplify in place", see Completed). C95 resolved July 25, 2026, evening (ruling #15, see Completed). C61 + C89 resolved July 25, 2026, evening (Group-A rulings #12/#13, see Completed). Earlier resolutions: C91–C94 July 12, 2026 (`content/meeting-content-session`); C76 + C85 + C86 + C87 July 11, 2026 (small-ready-slices arc); C70 (PR #128) + C72 (PR #129) + C73 (PR #130) July 5, 2026 (evening debt-pile pass); C64 (PR #138) July 5, 2026; C67 (`071c6df`) + C68 (`5b44d9e`) + C69 (`1db5c39`) July 4, 2026 on PR #119; C51 (`6e945e3`) + C58 (`3d8066a`) + C60 (`7898de6`) + C62-partial (`f1b1315`) July 4, 2026 on PR #120; C71 July 5, 2026 (post-merge docs pass); C74 July 5, 2026; C79 July 10, 2026 (balance-integrity arc slice 1)
