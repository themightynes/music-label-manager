...
- **Tier 2 MVP-2 executing** (PR-3 side-event selection/endpoint, PR-4 WeekSummary beat, PR-5 wrap + fresh-context verifier) — per the [READY] spec §7.
- Relevance weighting (2.0/4w): explicitly left alone July 5 (Nes) — revisit after more play. mood_crater threshold (20) and reactive fire-rates are new sibling knobs, same posture.
- Nes still owes the Phase 4 in-game audio audition.
- Carry-overs: remaining ledger pendings (13, all 🔵 low except C62 🟢; C64 closes in PR-3).
