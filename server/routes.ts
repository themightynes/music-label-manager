...
import { insertGameSaveSchema, gameSaveSnapshotSchema, insertWeeklyActionSchema, insertMusicLabelSchema, gameStates, gameSaves, weeklyActions, projects, songs, artists, releases, releaseSongs, roles, executives, musicLabels, moodEvents, emails, type GameSaveSnapshot, SNAPSHOT_VERSION } from "@shared/schema";
import { z } from "zod";
