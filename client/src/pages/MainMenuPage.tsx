...
export default function MainMenuPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-surface-app text-text-primary overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-8 pt-14 pb-4">
      ...
      <footer className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-2 px-8 pt-4 pb-14 font-mono text-[11px] uppercase tracking-[0.24em] text-text-muted">
