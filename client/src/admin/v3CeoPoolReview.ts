...
export const V3_CEO_POOL_MEETINGS: PoolReviewEntry[] = [
  ...
  },
  {
    ...
    "contentPending": false,
    "tier": "crisis",
    "gating": "requires release_out + tour_active, week >= 40, reputation >= 440 (0-700 scale, ruled 2026-07-25 per PENDING-DECISIONS #20 — national-press-tier anchor; ~13 rep/week pace reaches it ~week 34, so the week-40 gate stays the real limiter) · role ceo",
