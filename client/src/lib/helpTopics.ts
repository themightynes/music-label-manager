...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    tldr: 'Money buys moves, reputation opens doors, and creative capital fuels the art. They rarely refill at the same pace, so you are always trading one against the others.',
    body: [
      'You run on three resources, and they do different jobs. Money is the obvious one — it pays for everything you set in motion. Reputation is your standing in the industry, and it is what unlocks access: better playlists, real press attention, bigger venues. Creative capital is the fuel for the art itself; you spend it to start projects and to plan releases.',
    ...
    rules: [
      'Money buys moves, reputation opens doors, creative capital makes the art — respect what each one is for.',
      'Reputation is the one you cannot buy and the one that unlocks access tiers. Guard it.',
      'Keep some creative capital in reserve — being out of it stops the art cold, cash or no cash.',
    ],
    veteranNotes: [
  ...
  },
  {
    ...
    body: [
      ...
      'Meetings cost you focus. You have three slots to spend, and a fourth opens once your reputation has climbed far enough. Some choices also ask for a little creative capital — the pricier bets usually do. Spend those slots on the execs whose call matters most this week.',
    ...
    rules: [
      ...
      'You get three focus slots, with a fourth once your reputation is high enough. Spend them where the call matters.',
  ...
  },
  {
    ...
    tldr: 'Hype is anticipation you bank BEFORE a release and spend INTO it. Buzz — a song\'s awareness — is whether the public knows a released record exists and keeps it earning after launch week.',
    body: [
    ...
    rules: [
      'Hype is banked BEFORE the drop and spent INTO it; buzz is a released song\'s live awareness AFTER it.',
  ...
  },
  {
    ...
    body: [
      'A record is two jobs. First you record it — and there you are trading quality against cost and time. A stronger producer and more time invested lift the songs; both cost you. Then you release it, and releasing well is a craft of its own. Do not just drop a record and hope. Set it up.',
      ...
      'The weeks between planning and release are not dead air — that is your pre-release campaign, quietly building anticipation so the record arrives warm. This is where Hype from your meetings (see "Getting Heard") pours in. Planning early buys you runway to build; drop cold and you are starting the conversation on release day, which is late.',
    ],
    rules: [
      'Recording trades quality against cost and time — a better producer and more time cost you but lift the songs.',
      'Marketing channels have personalities: some build a long tail, some spike launch week. Mix for the shape you want.',
      'Set the record up before it drops — a pre-release campaign and a lead single make it land warm, not cold.',
    ],
    veteranNotes: [
  ...
  },
  {
    ...
    rules: [
      'A tour is cash now plus lasting popularity — reach for it when the bank is thin and the fans are real.',
  ...
  },
  {
    ...
    body: [
      ...
      'Charting is not only a mirror. A song doing well on the board feeds back into the label — it lifts your standing and keeps the record in the conversation. So the charts are worth watching closely, but I put this last on purpose: read them to learn, then go pull the levers that actually move them.',
    ],
    rules: [
      ...
      'Competitor songs share the board and keep moving, so judge your position against a field that is not standing still.',
    ],
  },
];
